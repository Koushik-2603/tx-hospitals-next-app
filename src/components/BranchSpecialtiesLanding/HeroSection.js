            ...
            >
                <div>
                    ...
                    <p className="text-gray-200 mt-6 text-base md:text-sm leading-relaxed max-w-xl">
                        At TX Hospitals {formattedLocation}, patients can access expert consultation,
                        advanced diagnostics and specialised treatment support across major medical departments.
                        For families searching for Top hospitals near {formattedLocation}, we offer organised,
                        patient-focused care in a convenient location.
                    </p>
