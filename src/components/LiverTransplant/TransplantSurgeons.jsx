...
const TransplantSurgeons = ({ data, onBookNow }) => {
    ...
    if (isMobile) {
        return (
            <section className="bg-pink-700 mt-4 py-6 px-4 font-inter text-white overflow-hidden">
                    ...
                    >
                        {doctors.map((doctor, index) => (
                            ...
                            >
                                ...
                                <div className="relative mb-4 p-2 border-2 border-pink-700/20 rounded-2xl bg-white shadow-inner">
                                    <div className="relative w-32 h-32 z-10">
                                        <img
                                            src={doctor?.image}
                                            alt={doctor?.name}
                                            className="relative z-10 w-full h-full rounded-sm object-cover transition-transform duration-500 hover:scale-110"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-2 w-full">
                                    <button
                                        onClick={onBookNow}
                                        className="flex items-center justify-center bg-pink-700 hover:bg-pink-800 text-white px-2 py-2 rounded-lg transition-colors shadow-md"
                                    >
                                        <div className="flex items-center gap-1 font-semibold text-[10px]">
                                            <img src="/assets/surgeries/live-transplant/Book an Appointment  Icon 3.webp" className="w-4 h-4 object-contain brightness-0 invert" alt="Book Appointment Icon" />
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center bg-[#b02a44] hover:bg-[#96253d] text-white py-2 rounded-lg font-semibold text-[11px] transition-colors shadow-md"
                                    >
                                        View Profile
                                    </button>
                                </div>
    ...
    // Desktop version
    return (
        <section className="bg-pink-800 py-10 px-6 md:px-6 mt-4 font-inter text-white overflow-hidden">
                    ...
                    >
                        {doctors.map((doctor, index) => (
                            ...
                            >
                                ...
                                {/* Info Table */}
                                <div className="w-full space-y-1 mb-4 text-left text-sm md:text-base px-2">
                                ...
                                {/* Buttons */}
                                <div className="mt-auto grid grid-cols-2 gap-3 w-full p-2">
                                    <button
                                        onClick={onBookNow}
                                        className="flex items-center justify-center bg-pink-700 hover:bg-pink-800 text-white px-2 py-2 rounded-xl transition-colors shadow-md group"
                                    >
                                        <div className="flex items-center gap-1 font-bold text-[10px] uppercase tracking-wider">
                                            <img src="/assets/surgeries/live-transplant/Book an Appointment  Icon 3.webp" className="w-6 h-6 object-contain brightness-0 invert" alt="Book Appointment Icon" />
                                            <span>Book An Appointment</span>
                                        </div>
                                    </button>
                                    ...
                                    <button
                                        onClick={() => window.open(doctor.url)}
                                        className="flex items-center justify-center bg-[#b02a44] hover:bg-[#96253d] text-white py-2 rounded-xl font-bold text-sm transition-colors shadow-md"
                                    >
                                        View Profile
                                    </button>
                                </div>
...
export default TransplantSurgeons;
