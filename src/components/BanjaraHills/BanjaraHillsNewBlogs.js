        ...
        <section id="blogs" className="py-10 md:py-12" style={{ background: 'rgb(243, 243, 245)' }}>
            <div className="max-w-[1170px] mx-auto px-6">
                <div className="text-center mb-10">
                    <h2 className="mb-3 text-2xl md:text-3xl lg:text-4xl font-bold" style={{ fontFamily: 'Poppins, sans-serif', color: 'rgb(3, 2, 19)' }}>
                        Health Insights &amp; <span style={{ color: 'rgb(189, 56, 92)' }}>Articles</span>
                    </h2>
                    <p className="max-w-[620px] mx-auto text-gray-700" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '15px', fontWeight: 400, lineHeight: 1.7 }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {blogs.map((blog, idx) => (
                        <Link 
                            href={blog.slug} 
                            key={idx} 
                            className="flex flex-col rounded-xl bg-white overflow-hidden hover:shadow-md transition-all duration-300 cursor-pointer group hover:-translate-y-0.5" 
                        ...
                        >
                            ...
                            <div className="flex flex-col flex-1 p-5 gap-3">
                                ...
                                <p className="flex-1 text-gray-500" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '13px', fontWeight: 400, lineHeight: 1.65, margin: '0px' }}>
                                    {blog.description}
                                </p>
                                <div className="flex items-center justify-between pt-3" style={{ borderTop: '1px solid rgb(240, 223, 229)' }}>
                                    ...
                                    <span className="flex items-center gap-1 group-hover:gap-2 transition-all font-semibold" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '12px', color: 'rgb(189, 56, 92)' }}>
