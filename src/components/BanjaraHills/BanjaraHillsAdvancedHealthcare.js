                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {cards.map((card, idx) => (
                        <motion.div
                            ...
                            className="bg-white border border-gray-100/80 rounded-[24px] p-6 flex flex-col justify-between hover:-translate-y-1.5 hover:shadow-[0_15px_35px_rgba(179,32,77,0.06)] hover:border-pink-100 transition-all duration-300 group cursor-pointer shadow-sm min-h-[220px]"
                        >
                            ...
                            <div className="flex justify-end mt-4">
                                <span className="text-[#b3204d] hover:text-[#971b41] text-xs font-bold transition-colors duration-300 flex items-center gap-1 group-hover:underline decoration-2 underline-offset-4">
