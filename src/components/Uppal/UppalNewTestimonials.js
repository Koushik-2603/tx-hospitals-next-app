                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden flex flex-col" style={{ border: '0.5px solid rgb(183, 183, 183)', boxShadow: 'rgba(0, 0, 0, 0.1) 0px 1px 1px, rgba(0, 0, 0, 0.06) 0px 1px 1.5px' }}>
                        ...
                        <div className="flex flex-col gap-3 p-5 flex-1">
                            ...
                            <div className="flex items-center gap-3 pt-3 border-t border-[#F0DFE5]">
                                <img src="/_components/v2/d95b7e9de330dae14d6e633ef3f646f12f5f0834/Testimonial.59c9eb79.jpeg" alt="Vamshi" className="w-9 h-9 rounded-full object-cover" />
                                <div>
                    ...
                    <div className="bg-white rounded-lg overflow-hidden flex flex-col" style={{ border: '0.5px solid rgb(183, 183, 183)', boxShadow: 'rgba(0, 0, 0, 0.1) 0px 1px 1px, rgba(0, 0, 0, 0.06) 0px 1px 1.5px' }}>
                        ...
                        <div className="flex flex-col gap-3 p-5 flex-1">
                            ...
                            <div className="flex items-center gap-3 pt-3 border-t border-[#F0DFE5]">
                                <img src="/_components/v2/d95b7e9de330dae14d6e633ef3f646f12f5f0834/Testimonial_1.96f6b0ad.jpeg" alt="Mr Emmanuel N" className="w-9 h-9 rounded-full object-cover" />
                                <div>
