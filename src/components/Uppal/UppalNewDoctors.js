    ...
    useEffect(() => {
        fetch(`${CONFIG.API_BASE_URL}/getAllDoctors`)
            ...
            .then((data) => {
                ...
                const targetIds = [
                    'drmkumarbhanu@txhospitals.in',
                    'drjagdishpusa@txhospitals.in',
                    'druazadhchandrashekhar@txhospitals.in'
                ];
        ...
        <section id="doctors" className="py-16 bg-white">
            <div className="max-w-[1170px] mx-auto px-6 lg:pr-11">
                <div className="text-center mb-10">
                    ...
                    <p 
                        className="max-w-[800px] mx-auto text-sm md:text-base leading-relaxed text-gray-700" 
                        style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 400 }}
                    >
                        At TX Hospitals, Uppal, our team of experienced specialists is dedicated to providing the highest standards of medical care. As one of the Top multispeciality hospitals in Uppal, we focus on accurate diagnosis, personalised treatment and a patient-first approach.
                    </p>
                </div>
                                    ...
                                    <div className="flex flex-col gap-3 p-5 flex-1">
                                        ...
                                        <div className="flex flex-col gap-1.5 mt-auto">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span style={{ fontFamily: 'Poppins, sans-serif', fontSize: '13px', color: 'rgb(30, 30, 30)' }}>
                                                    {doctor.location || 'Uppal, Hyderabad'}
                                                </span>
                                            </div>
                                        </div>
...
export default UppalNewDoctors;
