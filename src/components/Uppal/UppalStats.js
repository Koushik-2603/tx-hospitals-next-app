...
const UppalStats = () => {
    ...
    return (
        <section className="bg-pink-700 text-white py-10 md:py-16 px-6 md:px-10 lg:px-12">
                ...
                <div className="bg-white/10 rounded-2xl p-4 md:p-6 shadow-inner flex flex-col md:flex-row items-center gap-4 md:gap-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-3">
                        {branches.map((branch, index) => (
                            <button
                                key={index}
                                className={`px-5 py-2.5 rounded-full text-xs font-bold transition-all ${branch === "Uppal"
