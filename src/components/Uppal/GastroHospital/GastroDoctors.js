...
const GastroDoctors = ({ onBookClick }) => {
            ...
            try {
                ...
                const filteredDoctors = doctorDetails.map(detail => {
                    ...
                    return {
                        ...
                        department: match ? match.department : "Gastroenterology"
                    };
                });
                ...
                console.error("Error fetching gastro doctors:", error);
                setLoading(false);
            }
        };
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-12 text-center">
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
                        Best Gastro Health Specialists in Uppal
                    </h2>
                    <p className="text-gray-500 text-sm md:text-base max-w-2xl leading-relaxed font-medium mx-auto">
                        Our gastroenterologists bring advanced training, years of hands-on experience, and a genuine commitment to your wellbeing.
                    </p>
                </div>
