...
const KachigudaNewHero = () => {
    ...
    useEffect(() => {
        const fetchAllData = async () => {
            try {
                ...
                console.error("Error fetching options in KachigudaNewHero:", error);
            }
        };
        fetchAllData();
    }, []);
    ...
    const doctorOptions = getDoctorsForLocation('Kachiguda').map(doctor =>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                subject: `New Inquiry from Kachiguda Hero Section (${activeTab === 'appointment' ? 'Book Appointment' : activeTab === 'second-opinion' ? 'Second Opinion' : 'Book Health Checkup'})`,
                html: `
                    <h3>New Hero Section Inquiry - Kachiguda Landing Page</h3>
        ...
        <section id="home" className="relative flex overflow-hidden w-full -mt-2 md:mt-4" style={{ minHeight: '660px' }}>
            <div className="relative flex-grow hidden lg:block bg-white">
                <div className="absolute inset-0 bg-white">
                    <Image
                        src="/assets/Kachiguda/Kachiguda.png"
            ...
            >
                <div>
                    <h1 className="mb-5" style={{ fontFamily: 'Poppins, sans-serif', fontSize: 'clamp(22px, 2.8vw, 34px)', fontWeight: 600, color: 'rgb(255, 255, 255)', lineHeight: 1.25 }}>
                        Advanced Multispeciality Care in Kachiguda
                    </h1>
...
export default KachigudaNewHero;
