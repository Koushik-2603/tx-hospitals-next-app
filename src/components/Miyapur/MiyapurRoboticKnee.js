    ...
    return (
        <section style={{ background: 'rgb(243, 243, 245)' }}>
            <div className="flex flex-col lg:flex-row" style={{ minHeight: '440px' }}>
                <div className="flex-1 flex flex-col justify-center px-8 py-10 lg:py-14 lg:pl-14 lg:pr-10 order-2 lg:order-1">
                    <div className="max-w-[520px]">
                        ...
                        <ul className="flex flex-col gap-2 mb-8">
                            <li className="flex items-start gap-2">
                                ...
                                <span style={{ fontFamily: 'Poppins, sans-serif', fontSize: '14px', fontWeight: 400, color: 'rgb(30, 30, 30)', lineHeight: 1.6 }}>
                        ...
                        <button onClick={() => setIsModalOpen(true)} className="flex items-center gap-2 px-8 py-3 rounded transition-opacity hover:opacity-90 shadow-md w-fit" style={{ background: 'rgb(189, 56, 92)', fontFamily: 'Poppins, sans-serif', fontSize: '15px', fontWeight: 500, color: 'rgb(255, 255, 255)', border: 'none' }}>
                ...
                <div className="w-full lg:w-[48%] flex-shrink-0 order-1 lg:order-2 flex items-center justify-center" style={{ minHeight: '300px', padding: '24px' }}>
                    <div className="relative w-full h-full overflow-hidden" style={{ borderRadius: '20px', minHeight: '212px' }}>
                        <video 
