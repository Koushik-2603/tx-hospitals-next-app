        ...
        <section id="doctors" className="py-16 bg-white">
            <div className="max-w-[1170px] mx-auto px-6">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden flex flex-col" style={{ border: '0.5px solid rgb(183, 183, 183)', boxShadow: 'rgba(0, 0, 0, 0.12) 0px 1px 1px, rgba(0, 0, 0, 0.08) 0px 1px 1.5px' }}>
                        ...
                        <div className="flex flex-col gap-3 p-5 flex-1">
                            ...
                            <div className="flex gap-2 pt-4 border-t border-[#F0DFE5] mt-4">
                                <button onClick={() => setIsModalOpen(true)} className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded transition-opacity hover:opacity-90" style={{ background: 'rgb(189, 56, 92)', fontSize: '13px', fontWeight: 500, color: 'rgb(255, 255, 255)', border: 'none' }}>
                                    <Calendar className="w-[13px] h-[13px]" />
                                    Book Appointment
                                </button>
                                <a href="tel:9144514459" className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded transition-all hover:bg-[#BD385C] hover:text-white" style={{ background: 'rgb(255, 255, 255)', fontSize: '13px', fontWeight: 500, color: 'rgb(189, 56, 92)', border: '1px solid rgb(189, 56, 92)' }}>
                ...
                <div className="text-center">
                    <a href="/find-doctor?location=Miyapur" className="inline-block px-8 py-2.5 rounded transition-all hover:bg-[#BD385C] hover:text-white" style={{ background: 'rgb(255, 255, 255)', fontSize: '15px', fontWeight: 500, color: 'rgb(189, 56, 92)', border: '1.5px solid rgb(189, 56, 92)' }}>
                        View All Doctors
                    </a>
                </div>
            </div>
