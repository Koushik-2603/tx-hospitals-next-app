...
const MiyapurFAQ = () => {
    ...
    const faqs = [
        ...
        {
            question: "Does TX Hospitals, Miyapur have emergency services?",
            answer: "Yes, TX Hospitals, Miyapur provides 24/7 emergency and trauma care services with a dedicated team of experts ready to handle all medical emergencies."
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, TX Hospitals, Miyapur is equipped with state-of-the-art operation theaters and offers advanced surgical treatments, including robotic and minimally invasive surgeries."
        },
        {
        ...
        {
            question: "How can I book an appointment at TX Hospitals, Miyapur?",
    ...
    return (
        <section className="py-16" style={{ background: 'rgb(243, 243, 245)' }}>
