...
const MiyapurHero = () => {
    ...
    useEffect(() => {
        const fetchAllData = async () => {
            try {
                ...
                console.error("Error fetching options in MiyapurHero:", error);
            }
        };
        fetchAllData();
    }, []);
    ...
    const doctorOptions = getDoctorsForLocation('Miyapur').map(doctor => 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                subject: `New Inquiry from Miyapur Hero Section (${activeTab === 'appointment' ? 'Book Appointment' : activeTab === 'second-opinion' ? 'Second Opinion' : 'Book Health Checkup'})`,
                html: `
                    <h3>New Hero Section Inquiry - Miyapur Landing Page</h3>
            ...
            setFormData({ name: '', phone: '', location: 'Miyapur', doctor: '', date: '' });
    ...
    return (
        <section id="home" className="relative flex overflow-hidden w-full -mt-2 md:mt-0" style={{ minHeight: '560px' }}>
            ...
            >
                <div>
                    <h1 className="mb-0.5" style={{ fontSize: 'clamp(22px, 2.8vw, 34px)', fontWeight: 600, color: 'rgb(255, 255, 255)', lineHeight: 1.25 }}>
                        TX Hospitals,
                    </h1>
                    <p className="mb-5" style={{ fontSize: 'clamp(16px, 2vw, 22px)', fontWeight: 700, color: 'rgb(242, 58, 107)', lineHeight: 1.2 }}>
                        Miyapur, Hyderabad
                    </p>
