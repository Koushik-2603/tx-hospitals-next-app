...
export default function DiseasesTreatments({ department: propDepartment }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const endpoint = `${CONFIG.API_BASE_URL}/coe/getCategoryData/${department}/Diseases & Treatment`;
