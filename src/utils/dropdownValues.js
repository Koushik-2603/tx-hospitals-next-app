...
export const secondOpinion = [
    ...
    { name: "Breast Augmentation Surgery", path: "" },
    { name: "Carpal Tunnel Release Surgery", path: "" },
    { name: "Cerebral Aneurysm Surgery", path: "" },
    { name: "Coronary Artery Bypass Grafting (CABG)", path: "/coronary-artery-bypass-grafting-surgery/" },
    { name: "Diabetic Foot Surgery", path: "" },
    { name: "ERCP Surgery", path: "" },
    { name: "Fistula Surgery", path: "" },
    { name: "Gallbladder Stone Removal Surgery", path: "" },
    { name: "Gastric Sleeve Surgery", path: "/gastric-sleeve-surgery/" },
    { name: "Gynecomastia Surgery", path: "/gynecomastia-surgery/" },
    { name: "Hernia Surgery", path: "" },
    { name: "Hip Replacement Surgery", path: "" },
    { name: "Hysterectomy Surgery", path: "" },
    { name: "ICD Implantation Surgery", path: "" },
    { name: "Knee Replacement Surgery", path: "/knee-arthroscopy-surgery-hyderabad/" },
    { name: "Liposuction Surgery", path: "" },
    { name: "Myomectomy Surgery", path: "" },
    { name: "Ovarian Cyst Removal Surgery", path: "" },
    { name: "Percutaneous Nephrolithotomy (PCNL)", path: "" },
    { name: "Prostate Surgery", path: "" },
    { name: "Rhinoplasty Nose Surgery", path: "" },
    { name: "Rotator Cuff Surgery", path: "" },
    { name: "Thyroidectomy Surgery", path: "" },
    { name: "TURP – Transurethral Resection of Prostate", path: "" },
    { name: "Varicose Vein Surgery", path: "" }
]
